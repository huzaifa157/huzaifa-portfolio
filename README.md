...
- A downloadable resume at `public/resume.pdf` — this is the LaTeX/Overleaf PDF exported by hand, not generated by the site. To update it, export a new PDF from Overleaf and overwrite `public/resume.pdf`.
